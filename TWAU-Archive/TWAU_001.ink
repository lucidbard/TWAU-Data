...
= NEW_YORK_CITY_MONTAGE
	RADIO ANNOUNCER: 105 today if you missed it, a record for the day, hottest ever in June,
	Shot of a bridge in downtown New York.
	RADIO ANNOUNCER: 103 now, and that humidity looks low, but remember the hotter the air is, the more moisture it can hold, so 103 with 31% humidity is a lot more humid than, say, 73 with 31% humidity and it is muggy out there.
	-> OUTSIDE_APARTMENT
=== OUTSIDE_APARTMENT ===
	...
	-> APARTMENT
=== APARTMENT ===
	Bigby opens the door the building
	BIGBY: Mr. Toad?
...
right.
	...
	* [...]
	...
	TOAD: Then get the fuck back inside.
		-> UPSTAIRS_LANDING
=== UPSTAIRS_LANDING ===
	Upon arriving at the upstairs landing, you hear a female and male voice. There is a phone {not PHONE: emitting a beeping noise},
        {not HAS_MATCHBOOK: a matchbook} and a door.
 ...
 * [You need to leave.]
 * [What happened?]
 BIGBY: What the hell is going on? 
 -> WHAT_HAPPENED
 ...
 * [Are you all right?]
 * [...]
 - WOMAN: Listen, this is the start of a shitty night for me. I just need the money he owes me, then I can go. 
 * [Are you alright?]
 * [What happened?]
 BIGBY:  What happened?
- -> WHAT_HAPPENED
