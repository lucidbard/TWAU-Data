...
FRONT MATTER
 PDFPDF  (title page, copyright, conference & technical program chairs welcome, about SIGCHI and ACM, CHI papers & notes co-chairs message, from ACM SIGCHI's president and vice president, contents, organization, CHI papers & notes associate chairs, sponsors)
BACK MATTER
 PDFPDF  (author index)
APPEARS IN
Interaction
...
Author image not provided	 Elizabeth Mynatt

No contact information provided yet.
Bibliometrics: publication history
Publication years	1992-2017
Publication count	126
Citation Count	2,906
Available for download	106
Downloads (6 Weeks)	716
Downloads (12 Months)	4,465
Downloads (cumulative)	97,145
Average downloads per article	916.46
Average citations per article	23.06
View colleagues of Elizabeth Mynatt
Program Chairs


Author image not provided	 Geraldine Fitzpatrick

 homepage
 geraldine.fitzpatrickattuwien.ac.at
Bibliometrics: publication history
Publication years	1995-2017
Publication count	141
Citation Count	1,166
Available for download	94
Downloads (6 Weeks)	793
Downloads (12 Months)	5,161
Downloads (cumulative)	39,170
Average downloads per article	416.70
Average citations per article	8.27
View colleagues of Geraldine Fitzpatrick
...
Author image not provided	 Keith Edwards
...
Average downloads per article	353.50
Average citations per article	6.73
View colleagues of Keith Edwards


Tom Rodden	Tom Rodden

homepage 
Bibliometrics: publication history
Publication years	1988-2017
Publication count	184
Citation Count	2,756
Available for download	124
Downloads (6 Weeks)	934
Downloads (12 Months)	6,506
Downloads (cumulative)	126,626
Average downloads per article	1,021.18
Average citations per article	14.98
View colleagues of Tom Rodden
...
Atlanta, GA, USA — April 10 - 15, 2010
Pages	2644
...
Paper Acceptance Rate 302 of 1,346 submissions, 22%
...
collapse
SESSION: The infrastructure problem in HCI
Dan Olsen
...
collapse
SESSION: Dance, dust, and drama: designing design
Jodi Forlizzi
...
collapse
SESSION: Performance, stagecraft, and magic
Barry Brown
...
collapse
SESSION: User characteristics and large-scale tracking
Darren Gergle
...
collapse
SESSION: Understanding and supporting programming
Mira Dontcheva
...
collapse
SESSION: Machine learning and web interactions
Per Ola Kristensson
...
collapse
SESSION: Expressing and understanding opinions in social media
Cliff Lampe
...
collapse
SESSION: Subtle expressions through sound and text
John Zimmerman
...
collapse
SESSION: Mapping the landscape of sustainable HCI
...
The distribution of task time data in usability studies is positively skewed. Practitioners who are aware of this positive skew tend to report the sample median. Monte Carlo simulations using data from 61 large-sample usability tasks showed that the ... expand
...
We present findings from a field study of Wayve, a situated messaging device for the home that incorporates handwriting and photography. Wayve was used by 24 households (some of whom were existing social networks of family and friends) over a three-month ... expand
...
Families have a strong need to connect with their loved ones over distance. However, most technologies do not provide the same feelings of connectedness that one feels from seeing remote family members. Hence our goal was to understand if a video connection, ... expand
...
Digital mementos are increasingly problematic, as people acquire large amounts of digital belongings that are hard to access and often forgotten. Based on fieldwork with 10 families, we designed a new type of embodied digital memento, the FM Radio. It ... expand
SESSION: 1001 users
Elizabeth Buie
...
We describe an empirical, between-subjects study on the use of think-aloud protocols in usability testing of a federal data-dissemination Web site. This double-blind study used three different types of think-aloud protocols: a traditional protocol, a ... expand
...
Likert-type scales are used extensively during usability evaluations, and more generally evaluations of interactive experiences, to obtain quantified data regarding attitudes, behaviors, and judgments of participants. Very often this data is analyzed ... expand
...
More and more products and services are being deployed on the web, and this presents new challenges and opportunities for measurement of user experience on a large scale. There is a strong need for user-centered metrics for web applications, which can ... expand
...
In this paper we discuss a screening process used in conjunction with a survey administered via Amazon.com's Mechanical Turk. We sought an easily implementable method to disqualify those people who participate but don't take the study tasks seriously. ... expand
...
A typical consent dialog was shown in 2 x 2 x 3 experimental variations to 80,000 users of an online privacy tool. We find that polite requests and button texts pointing to a voluntary decision decrease the probability of consent---in contrast ... expand
...
We present data collected from a field study of 12 needle-crafters introduced to Spyn-mobile phone software that associates digital records (audio/visual media, text, and geographic data) with locations on fabric. We observed leisure needle-crafters ... expand
...
An intergenerational design team of children (ages 7-11 years old) along with graduate students and faculty in computer science and information studies developed a programming language for children, Toque. Concrete real-world cooking scenarios ... expand
...
We propose a cooking system that operates in an open environment. The system cooks a meal by pouring various ingredients into a boiling pot on an induction heating cooker and adjusts the heating strength according to the user's instructions. We then ... expand
SESSION: Displays where you least expect them
Chris Harrison
...
We introduce LensMouse, a novel device that embeds a touch-screen display -- or tangible 'lens' -- onto a mouse. Users interact with the display of the mouse using direct touch, whilst also performing regular cursor-based mouse interactions. We demonstrate ... expand
...
PACER is a gesture-based interactive paper system that supports fine-grained paper document content manipulation through the touch screen of a cameraphone. Using the phone's camera, PACER links a paper document to its digital version based on visual ... expand
...
MouseLight is a spatially-aware standalone mobile projector with the form factor of a mouse that can be used in combination with digital pens on paper. By interacting with the projector and the pen bimanually, users can visualize and modify the virtually ... expand
...
Researchers have detailed the importance of routines in how people live and work, while also cautioning system designers about the importance of people's idiosyncratic behavior patterns and the challenges they would present to learning systems. We wish ... expand
...
We present the design, development, and evaluation of an end-user installable, whole house power consumption sensing system capable of gathering accurate real-time power use that does not require installing a current transformer around the electrical ... expand
...
To supplement existing forms of communication such as telephone and e-mail, this research proposes a new method of communicating "awareness" between people who are separated by long distances. In this paper, we investigate cases where coincidences in ... expand
SESSION: Finding your mojo and doing some good
Deborah Tatar
...
Unlike machines, we humans are prone to boredom when we perform routine activities for long periods of time. Workers' mental engagement in boring tasks diminishes, which eventually, compromises their performance. The result is a double-whammy because ... expand
...
Social activity is becoming a central contributor to user experience (UX) in many modern Web services. The motivations, norms and rules of online communities have been widely researched, however, social activity and its UX in modern Web services is a ... expand
...
Developers spend significant time reading and navigating code fragments spread across multiple locations. The file-based nature of contemporary IDEs makes it prohibitively difficult to create and maintain a simultaneous view of such fragments. We propose ... expand
...
When designing novel GUI controls, interaction designers are challenged by the "immaterial" materiality of the digital domain; they lack tools that effectively support a reflecting conversation with the material of software as they attempt to conceive, ... expand
...
Readers face many obstacles on today's Web, including distracting content competing for the user's attention and other factors interfering with comfortable reading. On today's primarily English-language Web, non-native readers encounter even more problems, ... expand
...
We examine opportunities for ubiquitous technologies in retail shopping, jewelry shopping in this case, to supplement the unique information needs inherent to physical trials of tactile products. We describe an iterative design approach to develop a ... expand
...
As long as people have traveled, they have constructed bags to help them carry more items than their hands will hold. While quite effective at keeping things together, bags do a poor job of communicating when something is missing. We propose that there ... expand
SESSION: Graphs
Steve Feiner
...
Symbols are used in scatterplots to encode data in a way that is appropriate for perception through human visual channels. Symbol size is believed to be the second dominant channel after color. We study symbol size perception in scatterplots in the context ... expand
...
Color is commonly used to represent categories and values in many computer applications, but differentiating these colors can be difficult in many situations (e.g., for users with color vision deficiency (CVD), or in bright light). Current solutions ... expand
...
Guidelines for designing information charts (such as bar charts) often state that the presentation should reduce or remove 'chart junk' - visual embellishments that are not essential to understanding the data. In contrast, some popular chart designers ... expand
...
We describe a prevalent mode of information access in low-income communities of the developing world--intermediated interactions. They enable persons for whom technology is inaccessible due to non-literacy, lack of technology-operation skills, or financial ... expand
...
We present results from a qualitative study examining how professionals living and working in Nairobi, Kenya regularly use ICT in their everyday lives. There are two contributions of this work for the HCI community. First, we provide empirical evidence ... expand
...
This study reports results of an ethnographic action research study, exploring mobile-centric internet use. Over the course of 13 weeks, eight women, each a member of a livelihoods collective in urban Cape Town, South Africa, received training to make ... expand
...
We describe ViralVCD: a low cost method for tracing paths of information diffusion in developing communities using physical media. We instituted a participatory video framework for creation and dissemination of developmental videos in seven urban slums ... expand
SESSION: No touch
Rob Miller
...
In the growing field of tabletop computing research, there has been an understandable focus on interactive aspects of tabletop use, in terms of technology, design, and behavioural analysis. In this paper, I highlight the importance of considering also ... expand
...
This paper introduces two novel navigation techniques, CycloPan, for clutch-free 2D panning and browsing, and CycloZoom+, for integrated 2D panning and zooming. These techniques instantiate a more generic concept which we call Cyclo* (CycloStar). The ... expand
...
In this paper, we explore the challenges in applying and investigate methodologies to improve direct-touch interaction on intangible displays. Direct-touch interaction simplifies object manipulation, because it combines the input and display into a single ... expand
SECTION: Presentations
Agencies at the Interface: Expanding Frames and Accountable Cuts
Lucy Suchman
doi>10.1145/1753326.2167153
Full text: Mp3 Audio onlyMp3 Audio only  Mp4 VideoMp4 Video
The 2010 SIGCHI Social Impact Award
Allison Druin, Ben Bederson
doi>10.1145/1753326.2167154
Full text: Mp3 Audio onlyMp3 Audio only  Mp4 VideoMp4 Video
The 2010 SIGCHI Social Impact Award: Q&A
Allison Druin, Ben Bederson
doi>10.1145/1753326.2167155
Full text: Mp3 Audio onlyMp3 Audio only  Mp4 VideoMp4 Video
CHI 2010 Welcome
Elizabeth Mynatt, John White, Gerrit van der Veer
...
Full text: Mp3 Audio onlyMp3 Audio only  Mp4 VideoMp4 Video
Messy Futures: Culture, Technology and Research: Q&A
Genevieve Bell
...
Full text: Mp3 Audio onlyMp3 Audio only  Mp4 VideoMp4 Video
CHI Madness: Part 1
Mira Dontcheva, Matt Jones, Max L. Wilson
